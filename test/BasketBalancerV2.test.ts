...
import { ReignMock, Erc20Mock, Rewards, BasketBalancerV2 } from '../typechain';
...
describe('BasketBalancerV2', function () {

    let reign: ReignMock,reignToken:Erc20Mock, rewards: Rewards, balancer: BasketBalancerV2;
